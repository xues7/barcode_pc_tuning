...
do 
    ...
    do
        for f in $inputdir/${bp}_bp/*europa*.gz;
        do
                        ...
                        do      
                            ...
                            then
                                ...
                                then
                                    ...
                                    for cutoff in   $(bc <<< "scale =0;$totalScore*0.9/1")  $(bc <<< "scale =0;$totalScore*0.95/1") $(bc <<< "scale =0;$totalScore*1.05/1")  $(bc <<< "scale =0;$totalScore*1.1/1")   
                                    do 
                                         for length_cutoff in 30 50
                                         do
                                             for diff12 in  2 4 6 8  
                                             do 
