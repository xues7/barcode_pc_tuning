                        ...
                        do      
                            ...
                            then
                                ...
                                then
                                    ...
                                    for cutoff in  $(bc <<< "scale =0;$totalScore*1/1")  $(bc <<< "scale =0;$totalScore*0.9/1") $(bc <<< "scale =0;$totalScore*1.1/1")  $(bc <<< "scale =0;$totalScore*0.8/1")  $(bc <<< "scale =0;$totalScore*1.2/1")
                                    do 
                                         for length_cutoff in 30 50 100
                                         do
                                             for diff12 in 1 2 4 6
                                             do 
                                                 for length_cutoff2 in $length_cutoff
                                                 do 
